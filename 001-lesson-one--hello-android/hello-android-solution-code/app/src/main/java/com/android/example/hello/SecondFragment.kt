...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSecond.setOnClickListener {
            // 2 - Invoke function showMessage() passing the textMessage argument to show the message to the user
            showMessage("Hello Android")
        }
    }

    // 1 - Create the function showMessage() with one argument which receives a text.
     ...
     * @param textMessage: The text message to show to the user.
     */
